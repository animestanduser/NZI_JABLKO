...
from .models import Profile, Message, Friend_Request
...
def friends_invitations(request):
    if request.user.is_authenticated:
        return render(request, 'app/friends_invitations.html', {'users': User.objects.exclude(username=request.user.username)})
